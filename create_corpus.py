...
def create_date_single(split=False, capital = True, character = True):
    ...
    month_dict = {'01': [u'零壹', u'壹'],
                  ...
                  '10': [u'拾', u'壹拾', u'零拾', u'零壹拾'],
                  '11': [u'拾壹', u'壹拾壹', u'零壹拾壹'],
                  '12': [u'拾貳', u'壹拾貳', u'零壹拾貳']}
    day_dict = {'01': [u'零壹', u'壹'],
                '02': [u'零贰', u'零貳', u'贰', u'貳'],
                '03': [u'零叁', u'叁'],
                '04': [u'零肆', u'肆'],
                '05': [u'零伍', u'伍'],
                '06': [u'零陆', u'零陸', u'陆', u'陸'],
                ...
                '10': [u'拾', u'壹拾', u'零拾', u'零壹拾'],
                '11': [u'拾壹', u'壹拾壹', u'零拾壹', u'零壹拾壹'],
                '12': [u'拾贰', u'拾貳', u'壹拾贰', u'壹拾貳', u'零拾贰', u'零拾貳', u'零壹拾贰', u'零壹拾貳'],
                '13': [u'拾叁', u'壹拾叁', u'零拾叁', u'零壹拾叁'],
                '14': [u'拾肆', u'壹拾肆', u'零拾肆', u'零壹拾肆'],
                '15': [u'拾伍', u'壹拾伍', u'零拾伍', u'零壹拾伍'],
                ...
                '18': [u'拾捌', u'壹拾捌', u'零拾捌', u'零壹拾捌'],
                '19': [u'拾玖', u'壹拾玖', u'零拾玖', u'零壹拾玖'],
                '20': [u'贰拾', u'貳拾', u'零贰拾', u'零貳拾'],
                '21': [u'贰拾壹', u'貳拾壹', u'零贰拾壹', u'零貳拾壹'],
                '22': [u'贰拾贰', u'貳拾貳', u'零贰拾贰', u'零貳拾貳'],
                '23': [u'贰拾叁', u'貳拾叁', u'零贰拾叁', u'零貳拾叁'],
                '24': [u'贰拾肆', u'貳拾肆', u'零贰拾肆', u'零貳拾肆'],
                '25': [u'贰拾伍', u'貳拾伍', u'零贰拾伍', u'零貳拾伍'],
                '26': [u'贰拾陆', u'貳拾陸', u'零贰拾陆', u'零貳拾陸'],
                '27': [u'贰拾柒', u'貳拾柒', u'零贰拾柒', u'零貳拾柒'],
                '28': [u'贰拾捌', u'貳拾捌', u'零贰拾捌', u'零貳拾捌'],
                '29': [u'贰拾玖', u'貳拾玖', u'零贰拾玖', u'零貳拾玖'],
                '30': [u'叁拾', u'零叁拾'],
                '31': [u'叁拾壹', u'零叁拾壹']}
    time_from = int(time.mktime((2017, 1, 1, 8, 0, 0, 0, 0, 0)))
    time_to = int(time.mktime((2030, 1, 1, 8, 0, 0, 0, 0, 0)))
    # time_from_most_1 = int(time.mktime((2017, 10, 20, 8, 0, 0, 0, 0, 0)))
    # time_to_most_1 = int(time.mktime((2017, 11, 15, 8, 0, 0, 0, 0, 0)))
    # time_from_most_2 = int(time.mktime((2017, 6, 1, 8, 0, 0, 0, 0, 0)))
    # time_to_most_2 = int(time.mktime((2018, 4, 1, 8, 0, 0, 0, 0, 0)))
